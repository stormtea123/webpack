                                ...
                                plugins: function () {
                                    return [
                                        ...
                                        require('postcss-pxtorem')({
                                            rootValue: 100,
                                            unitPrecision: 5,
                                            propList: ["width", "height", "padding", "padding-top", "padding-right", "padding-bottom", "padding-left", "margin", "margin-top", "margin-right", "margin-bottom", "margin-left", "border-radius", "border", "border-left", "border-top", "border-right", "border-bottom","background", "background-size", "top", "left", "right", "bottom", "font-size", "line-height", "min-width", "min-height", "box-shadow"],
                                            selectorBlackList: [],
                                            replace: true,
                                            mediaQuery: false,
                                            minPixelValue: 5
